...
(function (global) {
  ...
  class MiniGolf {
    constructor(host, options) {
      ...
      this.host.innerHTML = "";
      this.host.style.cssText += ";position:relative;min-height:520px;width:100%;overflow:hidden;background:#dff0dc;border-radius:18px;touch-action:none;";
      ...
      this.root.innerHTML = `
        <style>
          ...
          .gmmg-card{pointer-events:auto;background:rgba(250,247,235,.94);border:2px solid rgba(36,83,47,.16);box-shadow:0 7px 24px rgba(25,58,31,.15);border-radius:14px;padding:9px 12px;color:#21482c}
          ...
          .gmmg-btn{border:0;border-radius:10px;padding:8px 10px;background:#2f6b3d;color:#fff;font-weight:800;cursor:pointer}
    ...
    makeHoles() {
      ...
      return [
        ...
        },
        {
          ...
          sand:[{x:380,y:455,w:100,h:60,r:18}], water:[{x:645,y:95,w:245,h:150,r:55}],
    ...
    bindInput() {
      this.canvas.addEventListener("pointerdown",(e)=>{
        ...
        const p=this.pointerPos(e), d=Math.hypot(p[0]-this.ball.x,p[1]-this.ball.y);
        if(d<38){
