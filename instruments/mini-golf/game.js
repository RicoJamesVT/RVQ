...
(function (global) {
  ...
  class MiniGolf {
    ...
    update(dt) {
      ...
      // Course edge: bounce if outside playable polygon. Push the ball back to
      // just inside the nearest boundary edge and reflect off that edge's real
      // normal (see nearestFairwayEdge/reflectFromEdge below).
